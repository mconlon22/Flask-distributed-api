    import {addHouseMarkers} from './rentsChart.js'

    export  function getAddresses(lat, lon,Address,numBeds,propertyType) {
    var values=[]
  ...
  export function getRentData(lat,lon,numBeds,propertyType,callback){
          var values=[]
        var suburb=''    
