import {getAddresses,getRentData} from './axiosHelper.js'
...
var lon
var place
const mymap = L.map('mapid').setView([53.28209075, -6.408079325], 10);
 ...
 attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    ...
    var numBeds=document.getElementById('numBeds').value;
        getRentData( lat,lon,numBeds,propertyType)
        var soldHouses=getAddresses(lat,lon,numBeds,propertyType)
...
export function addHouseMarkers(soldHouses){
